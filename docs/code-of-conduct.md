# COMMUNITY_NAME Community Code of Conduct

COMMUNITY_NAME is dedicated to creating a welcoming, supportive and diverse
...
* when representing COMMUNITY_NAME in public,
* or in any event online or in person where COMMUNITY_NAME is leading the event.
...
they don’t belong at COMMUNITY_NAME. If somebody makes such a statement without
...
## Scope in which the COMMUNITY_NAME code of conduct is applied

COMMUNITY_NAME community members are held to the standards outlined in this
code of conduct when interacting in the COMMUNITY_NAME Zulip or GitHub
repositories, when interacting in-person at events where they could
represent COMMUNITY_NAME (this is most professional events), in physical spaces
or with other COMMUNITY_NAME team members or collaborators.

In addition, the COMMUNITY_NAME community and experience often extends outside
those spaces—COMMUNITY_NAME community members may go on walks together to get
...
* Permissions will be removed from any COMMUNITY_NAME-related repositories and/or accounts.
...
COMMUNITY_NAME Code of Conduct Stewards using this form.](https://forms.gle/7MR7tCpDuprtStWP9)
...
Moderators and members of the Steering Council are visible on the home page of the COMMUNITY_NAME website. You can contact them either via Zulip or via the contact details listed on the website.
...
## License
The COMMUNITY_NAME code of conduct is available under the terms of the CC0 license.
